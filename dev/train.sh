...
prefix="."
train_path="./data/train_data_blood.csv"
vld_path="./data/test_data_blood.csv"
...
# Stage 1
cnf_file="${prefix}/blood_model.toml"
...
python dev/train.py --train_path $train_path --vld_path $vld_path --cnf_file $cnf_file --ckpt_path $ckpt_path --d_model 128 --nhead 1 \
                    --num_epochs 128 --batch_size 256 --lr 1e-3 --gamma 1 --img_mode $img_mode --img_net $img_net --img_size "(182,218,182)" \
